...
public record UnconfirmedPoliciesApiResponse(
	...
	public static UnconfirmedPoliciesApiResponse from(PolicyDto policyDto) {
		return new UnconfirmedPoliciesApiResponse(
